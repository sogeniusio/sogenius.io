    ...
    <section class="container about  pad-top pad-bottom">
      ...
      <div class="row">
            <article class="col-md-5 text-left  inner-pad">
              <h6 class="super-text font2bold black"><?php echo e(date('F j, Y', strtotime($post->created_at))); ?>,<br/>by Admin</h6>
            </article>
            <article class="col-md-5 col-md-offset-2 text-left ">
              <h3 class="main-heading font2light black"><?php echo e($post->excerpt); ?></h3>
            </article>
      </div>
