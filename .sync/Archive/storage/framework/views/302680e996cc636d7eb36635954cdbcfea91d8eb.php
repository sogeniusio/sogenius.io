                ...
                <?php $__currentLoopData = $posts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                    <div class="row">
                        <article class="col-md-8 col-md-offset-2 text-left ">
                            <h3 class="font2bold black"><a href="<?php echo e(url('blog/' . $post->slug)); ?>"><?php echo e($post->title); ?>   <i class="fa fa-angle-right" aria-hidden="true"></i>
            </a></h3>
                            ...
                            <a href="<?php echo e(url('news/' . $post->slug)); ?>" class="btn btn-oscar btn-oscar-dark" >View Post</a>
                        </article>
                    </div>
