...
<?php $__env->startSection('content'); ?>
  ...
  <div class="row">
      <div class="col-lg-8">
          ...
          <h1 class="page-header"><?php echo e($post->title); ?></h1>

      </div>

      <div class="col-lg-4">
        <a href="<?php echo e(route('posts.index')); ?>" class="btn btn-default"><span><i class="fa fa-angle-left"></i></span> Back to posts list</a>
          ...
          <div class="panel panel-default">
              ...
              <div class="panel-body">
                ...
                <div class="row">
                  ...
                  <div class="col-lg-4">
                    <ul>
                      <li><i class="fa fa-globe" aria-hidden="true"></i> <?php echo e(url($post->slug)); ?></li>
                      ...
                      <li><i class="fa fa-calendar"></i> <?php echo e(date('M j, Y h:ia', strtotime( $post->created_at ))); ?></li>
                      <li><i class="fa fa-comments-o"></i> <?php echo e($post->comments()->count()); ?> Comments</li>
                      <li><i class="icon-share"></i> <a href="#">39 Shares</a></li>
                      <li></li>
                    </ul>
                          </div>
                </div>
