                ...
                <div class="panel-body">
                    ...
                    <div class="form-content">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
                                <?php echo e(Form::label('feat_image', "Featured Image:")); ?>

                                <?php echo e(Form::file('feat_image')); ?>
                            ...
                            <div class="form-group">
                                ...
                                <?php echo e(Form::textarea('body', null, array('id' => 'post_body', 'class' => 'tiny-textarea form-control'))); ?>

                            </div>

                            <div class="form-group">
                                <?php echo e(Form::submit('Create Post', array('class' => 'btn btn-success btn-md btn-block'))); ?>
