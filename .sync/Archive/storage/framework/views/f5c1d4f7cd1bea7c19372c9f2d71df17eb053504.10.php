    ...
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">Edit Post
                <small>id: <?php echo e($post->id); ?></small>
            </h1>
        </div>
    </div>
                        ...
                        <div class="post">
                            ...
                            <div class="post-content">
                                <div class="row">
                                    ...
                                    <div class="col-lg-12" style="margin-top: 20px;">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <?php echo e(Form::textarea('excerpt', null, array('id' => 'post_excerpt', 'class' => 'form-control', 'style' => 'min-height: 200px;'))); ?>
                                ...
                                <div class="entry-summary">
                                    ...
                                    <?php echo e(Form::textarea('body', null, ['class' => 'tiny-textarea form-control'])); ?>
