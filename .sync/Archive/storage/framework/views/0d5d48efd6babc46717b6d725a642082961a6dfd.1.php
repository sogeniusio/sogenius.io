      ...
      <div class="row">
            ...
            <article class="col-md-3 text-left">
                  ...
                  <ul class="content-list">
                    <?php $__currentLoopData = $archives; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $archive): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                      <li><a href="<?php echo e(url('news/' . $archive->slug)); ?>"><?php echo e($archive->title); ?></li></a>
