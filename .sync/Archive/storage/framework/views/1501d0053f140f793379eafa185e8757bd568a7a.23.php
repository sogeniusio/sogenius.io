            ...
            <ul class="nav" id="side-menu">
                ...
                <li>
                    ...
                    <ul class="nav nav-second-level">
                        <li>
                          <a href="<?php echo e(route('posts.index')); ?>">View Posts</a>
                        </li>
                        <li>
                ...
                <li>
                    <a href="<?php echo e(route('categories.index')); ?>"><i class="fa fa-table fa-fw"></i> View Categories</a>
                </li>
                
                
                <li>
                    <a href="<?php echo e(route('tags.index')); ?>"><i class="fa fa-table fa-fw"></i> View Tags</a>
                </li>
