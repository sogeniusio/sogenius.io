...
<head>
  ...
  –––––––––––––––––––––––––––––––––––––––––––––––––– -->
    <meta charset="utf-8">
    <title>So Genius I/O <?php echo $__env->yieldContent('title'); ?></title>
  ...
  –––––––––––––––––––––––––––––––––––––––––––––––––– -->
    ...
    <?php echo e(Html::style('/elements/css/elements.css')); ?>

    <?php echo e(Html::style('/css/sinister.css')); ?>

    <?php echo e(Html::style('/css/venobox.css')); ?>

    <?php echo e(Html::style('/css/slimmenu.css')); ?>

    <?php echo e(Html::style('/css/main.css')); ?>

    <?php echo e(Html::style('/css/main-bg.css')); ?>

    <?php echo e(Html::style('/css/main-responsive.css')); ?>
