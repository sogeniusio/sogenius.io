      ...
      <div class="col-lg-12">
          <div class="panel panel-default">
              <div class="panel-heading">
                <div class="row">
                  <div class="container">
                    <p class="post-metadata"><i class="fa fa-globe" aria-hidden="true"></i> <?php echo e(url($post->slug)); ?> |
    	...
    	| <i class="fa fa-calendar"></i> <?php echo e(date('M j, Y h:ia', strtotime( $post->created_at ))); ?>

     	| <i class="fa fa-comments-o"></i> <?php echo e($post->comments()->count()); ?> Comments
       	| <i class="icon-share"></i> <a href="#">39 Shares</a></p>
                  </div>
