<?php $__env->startSection('stylesheets'); ?>
  ...
  <?php echo e(Html::style('stylesheets/owl.carousel.css')); ?>
    ...
    <section class="container about  pad-top pad-bottom">
      ...
      <div class="row">
            <article class="col-md-5 text-left  inner-pad">
              <h6 class="super-text  font2bold black">Hosnel <span class="last-name"><br/>Guerrier</span></h6>
            </article>
            <article class="col-md-5 col-md-offset-2 text-left ">
              <h3 class="main-heading  font2light white">Hello everyone! <br/>oscar is a portfolio of web designer John Doe.</h3>
            </article>
      </div>
    ...
    <section class="container about  pad-top pad-bottom">
      ...
      <div class="row">
            <article class="col-md-8 col-md-offset-2 text-left ">
              ...
              <h3 class="main-heading  font2light black">I am a 26 years old freelance web developer / designer based in New York City. I build beautiful and functional websites for small businesses and brands. I am completely self-taught, specializing in brand design, development &amp strategy, website &amp mobile applications, user experience, email design &amp marketing, and print design. </p>
                    <br/><br/>
              <div class="signature">
            ...
            <div class="owl-carousel owl-nav-sticky-extra-wide testimonial-carousel ">
              ...
              <div class="testimonial-block text-center">
                  ...
                  <img alt="" title="" src="images/testimonial/01.jpg">
                    <h3 class="sub-heading  font2 white">Designova is our most favorite theme developers. We love their every works.</h3>
                    <p>Clara Sealand</p>
