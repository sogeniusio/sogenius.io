...
<?php $__env->startSection('stylesheets'); ?>
    ...
    <script type="text/javascript" src="<?php echo e(asset('/js/packages/tinymce/tinymce.min.js')); ?>"></script>
                  ...
                  <div class="panel-body">
                    ...
                    <div class="form-content">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
                                <?php echo e(Form::submit('Create Post', array('class' => 'btn btn-primary btn-lg btn-block'))); ?>
