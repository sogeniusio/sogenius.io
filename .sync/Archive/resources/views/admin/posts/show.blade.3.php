      ...
      <div class="col-lg-12">
          <div class="panel panel-default">
              <div class="panel-heading">
                <div class="row">
                  <div class="container">
                    <p class="post-metadata"><i class="fa fa-globe" aria-hidden="true"></i> {{ url($post->slug) }} |
    	...
    	| <i class="fa fa-calendar"></i> {{ date('M j, Y h:ia', strtotime( $post->created_at )) }}
     	| <i class="fa fa-comments-o"></i> {{ $post->comments()->count() }} Comments
