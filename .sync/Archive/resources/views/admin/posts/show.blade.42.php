                  ...
                  <div class="col-lg-4">
                    <div class="card">
                      ...
                      <ul class="list-group list-group-flush">
                        ...
                        <li class="list-group-item"><i class="fa fa-calendar"></i> {{ date('M j, Y h:ia', strtotime( $post->created_at )) }}</li>
                        ...
                        <li class="list-group-item"><i class="fa fa-tags"></i>
                            ...
                            @endforeach</li>
                            <li class="list-group-item"><i class="fa fa-comments-o"></i> {{ $post->comments()->count() }} Comments</li>
 ...
 <a href="#">39</a> Shares</li>
                      ...
                      <div class="card-block">
                        ...
                        <div class="btn-group" role="group" aria-label="Basic example">
                          <button type="button" class="card-link btn btn-secondary">Left</button>
                          <button type="button" class="card-link btn btn-secondary">Middle</button>
                          <button type="button" class="card-link btn btn-secondary">Right</button>
                        </div>
