    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="row options">
                <div class="col-md-12">
                    <a href="{{ route('posts.index') }}" class="btn2 btn2-default"><span><i
                                    class="fa fa-angle-left"></i></span> Back to posts list</a>
                    {!! Html::linkRoute('posts.edit', 'Edit', array( $post->id ), array('class' => 'btn2 btn2-primary')) !!}
                </div>
                    ...
                    <div class="post">
                        ...
                        <div class="post-content">
                            ...
                            <div class="row row-fix text-center">
                                ...
                                {!! Form::submit('Delete Post', ['class' => 'btn2 btn2-danger special', 'style' => 'border-radius: 0px;']) !!}
