 ...
 <a href="#">39</a> Shares</li>
                      ...
                      <div class="card-block">
                        ...
                        <div class="btn-group" role="group" aria-label="Basic example">
                          <button type="button" class="card-link btn btn-default">Left</button>
                          <button type="button" class="card-link btn btn-default">Middle</button>
                          <button type="button" class="card-link btn btn-default">Right</button>
                        </div>
