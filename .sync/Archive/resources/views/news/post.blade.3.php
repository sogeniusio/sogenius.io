        ...
        <section class="container about  pad-top pad-bottom">
            ...
            <div class="row">
                <article class="col-md-5 text-left  inner-pad">
                    <h6 class="super-text  font2bold black">{{ date('M j, Y', strtotime( $post->created_at )) }},<br/>by Admin</h6>
                </article>
                <article class="col-md-5 col-md-offset-2 text-left ">
                    <h3 class="main-heading  font2light black">The over-all point is that new technology will not
                        necessarily replace old technology, but it will date it. By definition. Eventually, it will
                        replace it</h3>
                </article>
            </div>
                ...
                <div class="row">
                    <article class="col-md-9 text-left">
                        ...
                        <div class="news-post inner-pad">
                            ...
                            <p class="add-top-half">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do
                                eiusmod
                    ...
                    <article class="col-md-3 text-left">
                        ...
                        <p class="dark add-bottom-quarter">Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                            Praesent at lacinia est, sed gravida purus. Donec pretium euismod enim. In id magna id lacus
                            tincidunt blandit non quis ante. Maecenas nec turpis at odio volutpat ullamcorper.</p>
