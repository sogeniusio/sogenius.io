        ...
        <section class="container silver-bg ">
          ...
          <div class="row pad">
              ...
              <article class="col-md-6 text-left bx1-margin registrar">
                ...
                {{ Form::text('registrar', null, array('class' => 'form-control input-with-caption', 'maxlength' => '100', 'required' => '')) }}
              ...
              <article class="col-md-6 text-left bx1-margin hosting">
                ...
                {{ Form::text('hosting', null, array('class' => 'form-control input-with-caption', 'maxlength' => '100', 'required' => '')) }}
              ...
              <article class="col-md-12 text-left bx1-margin needs">
                ...
                {{ Form::textarea('siteneeds', null, ['class' => 'form-control', 'required' => '']) }}
              ...
              <article class="col-md-12 text-left bx1-margin updates">
                ...
                {{ Form::textarea('updates', null, ['class' => 'form-control', 'required' => '']) }}
              ...
              <article class="col-md-12 text-left bx1-margin">
                ...
                {{ Form::text('audience', null, array('class' => 'form-control input-with-caption', 'maxlength' => '100', 'required' => '')) }}
              ...
              <article class="col-md-12 text-left bx1-margin">
                  <p class="input-caption">If you have a lot of data / files to share, please share on Dropbox.com. Invite hos@sogenius.io to your shared folder.</p> --}}
