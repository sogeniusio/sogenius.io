        ...
        <li class="dropdown">
            ...
            <ul class="dropdown-menu dropdown-user">
              @if (Auth::guest())
                    ...
                    <li><a style="font-size: 13px; font-weight: 700; border:none;" class="btn btn-primary btn-sm" href="{{ url('/register') }}">Register</a></li>
                @else
                    <li class="dropdown">
            ...
            <ul class="nav" id="side-menu">
                ...
                <li>
                    ...
                    <ul class="nav nav-second-level">
                        ...
                        {{--CATEGORIES--}}
                        <li>
                            <a href="{{ route('types.index') }}"><i class="fa fa-table fa-fw"></i> View Types</a>
                        </li>
                        {{-- END CATEGORIES--}}
                        {{--TAGS--}}
                        <li>
                            <a href="{{ route('identities.index') }}"><i class="fa fa-table fa-fw"></i> View Identities</a>
                        </li>
                        {{-- END TAGS--}}
                    </ul>
                    <!-- /.nav-second-level -->
