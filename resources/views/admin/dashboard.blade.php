        ...
        <div class="col-lg-3 col-md-6">
            <div class="panel panel-primary">
                <div class="panel-heading">
                    <div class="row">
                        <div class="col-xs-3">
                            <span class="glyphicon glyphicon-book glyphicon-5x"></i>
                        </div>
        ...
        <div class="col-lg-3 col-md-6">
            <div class="panel panel-green">
                <div class="panel-heading">
                    <div class="row">
                        <div class="col-xs-3">
                            <i class="glyphicon glyphicon-folder-open glyphicon-5x"></i>
                        </div>
                        <div class="col-xs-9 text-right">
                ...
                <a href="{{url('admin/projects')}}">
                    <div class="panel-footer">
                        <span class="pull-left">View All Projects</span>
                        <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                        <div class="clearfix"></div>
                    </div>
                </a>
        ...
        <div class="col-lg-4">
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    ...
                    <!-- /.list-group -->
                    <a href="#" class="btn btn-primary btn-block">View All Alerts</a>
                </div>
                <!-- /.panel-body -->
            </div>
            <!-- /.panel -->
